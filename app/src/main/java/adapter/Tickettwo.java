...
public class Tickettwo extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        viewHolder.tv_seat1.setText((String)data.get(position).get("tv_seat1"));
        viewHolder.tv_seat2.setText((String)data.get(position).get("tv_seat2"));
        viewHolder.tv_seat3.setText((String)data.get(position).get("tv_seat3"));
        viewHolder.tv_seat4.setText((String)data.get(position).get("tv_seat4"));
        return convertView;
    }
